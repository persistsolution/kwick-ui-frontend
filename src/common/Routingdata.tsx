...
import AddMRPProductForm from "../components/Client-side/Selling-Products/ViewMRPProduct/AddMRPProduct";
import AddOtherProductForm from "../components/Client-side/Selling-Products/OtherProducts/AddOtherProductForm";
import EditMrpProductForm from "../components/Client-side/Selling-Products/ViewMRPProduct/EditMRPProduct";
...
import EditGodownAccount from "../components/Client-side/GoDown/GodownAccount/EditGodownAccount";
...
import ViewTransferPrdToCocoFr from "../components/Client-side/Report/ViewTransferStockToCocoFr";
...
import ViewRawInventoryStockReport from "../components/Client-side/SubFranchise/InventoryReports/ViewRawInventoryStockReport";
...
import ViewMinMRPInventoryStockReport from "../components/Client-side/SubFranchise/InventoryReports/ViewMinMRPInventoryStockReport";
...
export const RouteData: routeType[] = [
  ...
  {
    id: 12,
    path: `${import.meta.env.BASE_URL}SellingProduct/AddMRPProductForm`,
    element: <AddMRPProductForm />,
  },
  {
    id: 12,
    path: `${import.meta.env.BASE_URL}SellingProduct/EditMRPProductForm/:id`,
    element: <EditMrpProductForm />,
  }
  ,
  {
    id: 12,
  ...
  {
    id: 30,
    path: `${import.meta.env.BASE_URL}GoDown/EditGodownAccount/:id`,
    element: <EditGodownAccount />,
  },
  {
    id: 31,
  ...
  {
    id: 52,
    path: `${import.meta.env.BASE_URL}Franchises/SellingProducts/ViewProduct`,
...

  {
    id: 59,
    path: `${import.meta.env.BASE_URL
      }Franchises/ViewCreditOrderAccount`,
...

  {
    id: 59,
    path: `${import.meta.env.BASE_URL
      }Franchises/ViewMRPInvenotoryStockReport`,
...

  {
    id: 59,
    path: `${import.meta.env.BASE_URL
      }Franchises/ViewRawInventoryStockReport`,
...

  {
    id: 59,
    path: `${import.meta.env.BASE_URL
      }Franchises/ViewAssetsInventoryStockReport`,
...

  {
    id: 59,
    path: `${import.meta.env.BASE_URL
      }Franchises/ViewMinMRPInventoryStockReport`,
...

  {
    id: 59,
    path: `${import.meta.env.BASE_URL
      }Franchises/ViewTopSellingProduct`,
...

  {
    id: 59,
    path: `${import.meta.env.BASE_URL
      }Franchises/GRN/ViewMRPProductGRN`,
...

  {
    id: 59,
    path: `${import.meta.env.BASE_URL
      }Franchises/GRN/ViewRawProductGRN`,
