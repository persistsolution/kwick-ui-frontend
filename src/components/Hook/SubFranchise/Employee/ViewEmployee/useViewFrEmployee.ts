...
import { deleteFrEmployee, fetchFrEmployee ,  } from "../../../../api/SubFranchise-API/EmployeeApi/ViewEmployeeApi/ViewEmployeeApi";

const useViewFrEmployee = () => {
  ...
  const handleFetchEmployee = async () => {
    try {
      const response: any = await fetchFrEmployee();
  ...
  const handleDeleteEmployee = async (id: number) => {
    try {
      ...
      const response = await deleteFrEmployee(id);
...
export default useViewFrEmployee;
