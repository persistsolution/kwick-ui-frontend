              ...
              <Card.Body>
                <div className="row align-items-center g-2 mb-3">
                  ...
                  <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                    <Form.Select
                      value={FinancerPerPage}
                      onChange={(e) =>
                        setFinancerPerPage(Number(e.target.value))
                      }
                      className="w-auto"
                    >
                      ...
                      <option value={filteredFinancer.length}>All Items</option>
                    </Form.Select>
                ...
                <div className="table-responsive">
                  ...
                  >
                    ...
                    <tbody>
                      {filteredFinancer.length > 0 ? (
                        filteredFinancer.map((category: any) => (
                          <tr key={category.id}>
                            <td>{category.id}</td>
                            <td>
                              <img
                            ...
                            <td>
                              <span
                                ...
                                onClick={() =>
                                  handleDeleteFinancer(category.id)
                                }
                              >
                ...
                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                  <div>
                    Showing {indexOfFirstFinancer + 1} to{" "}
                    {Math.min(indexOfLastFinancer, filteredFinancer.length)} of{" "}
                    {filteredFinancer.length} entries
                  </div>
