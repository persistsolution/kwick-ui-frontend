              ...
              <Card.Body>
                <div className="row align-items-center g-2 mb-3">
                  ...
                  <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                    <Form.Select
                      value={viewGodownPendingRequestPerPage}
                      onChange={(e) =>
                        setviewGodownPendingRequestPerPage(
                    ...
                    >
                      ...
                      <option value={viewGodownPendingRequest.length}>
                        All Items
                      </option>
                    </Form.Select>
                ...
                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                  <div>
                    Showing {indexOfFirstGodownPendingRequest + 1} to{" "}
                    {Math.min(
                      indexOfLastGodownPendingRequest,
                      viewGodownPendingRequest.length
                    )}{" "}
                    of {viewGodownPendingRequest.length} entries
                  </div>
...
export default ViewGodownPendingRequest;
