        ...
        <Row>
          <Col xl={12}>
            <Card className="custom-card">
              <Card.Body>
                <Form onSubmit={handleFetchTargetCompletionReport}>
                  <Container>
                    <Row className="gy-4">
                      <Col xl={3}>
                      ...
                      <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                        <Form.Select
                          value={TargetCompletionReportPerPage}
                          onChange={(e) =>
                            setTargetCompletionReportPerPage(
                        ...
                        >
                          ...
                          <option value={TargetCompletionReport.length}>
                            All Items
                          </option>
                        </Form.Select>
                      ...
                      <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                        <div>
                          Showing {indexOfFirstTargetCompletionReport + 1} to{" "}
                          {Math.min(
                            indexOfLastTargetCompletionReport,
                            TargetCompletionReport.length
                          )}{" "}
                          of {TargetCompletionReport.length} entries
                        </div>
...
export default ViewTargetCompletionReport;
