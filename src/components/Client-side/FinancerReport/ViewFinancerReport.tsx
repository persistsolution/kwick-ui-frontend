              ...
              <Card.Body>
                <div className="row align-items-center g-2 mb-3">
                  ...
                  <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                    <Form.Select
                      value={stockReportPerPage}
                      onChange={(e) =>
                        setstockReportPerPage(Number(e.target.value))
                      }
                      className="w-auto"
                    >
                      ...
                      <option value={stockReport.length}>All Items</option>
                    </Form.Select>
                ...
                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                  <div>
                    Showing {indexOfFirststockReport + 1} to{" "}
                    {Math.min(indexOfLaststockReport, stockReport.length)} of{" "}
                    {stockReport.length} entries
                  </div>
...
export default ViewFinancerReport;
