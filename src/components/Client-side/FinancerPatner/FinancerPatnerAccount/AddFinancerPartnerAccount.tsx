                    ...
                    <Row className="gy-4">
                      <Col xl={12}>
                        <Form.Group controlId="financerPatnerName">
                          <Form.Label>
                            Financer/Partner Name <span className="text-danger">*</span>
                          </Form.Label>
                          <Form.Control
                            type="text"
                            name="FinancerPatnerAccountName"
                      ...
                      <Col xl={4}>
                        <Form.Group controlId="commisionPercentage">
                          <Form.Label>
                            Commision Percentage <span className="text-danger">*</span>
                          </Form.Label>
                          <Form.Control
                            type="text"
                            name="commisionPercentage"
                            placeholder="Commision Percentage"
                            value={formData.commisionPercentage}
                            onChange={handleChange}
                            required
                          />
                        </Form.Group>
