...
import useAddMRPProductForm from "../../../Hook/Selling-Products-Hook/ViewMRPProducts/useAddMRPProduct";
...
const AddMRPProductForm: FC = () => {
  const { formValues , loading, rawProductArray, handleSubmit, handleChange, setFormValues } =
    useAddMRPProductForm();
  return (
    <Fragment>
      {/* <Pageheader 
        heading="Add Product"
        ...
        <Row>
          <Col xl={12}>
            <Card className="custom-card">
              <Card.Header>
                <div className="card-title">Add Customer product</div>
              </Card.Header>
              <Card.Body>
...
export default AddMRPProductForm;
