...
import useAddOtherProductForm from "../../../Hook/Selling-Products-Hook/OtherProductsTS/useAddOtherProductForm";
...
const AddOtherProductForm: FC = () => {
  ...
  return (
    <Fragment>
      {/* <Pageheader 
        heading="Add OtherProduct"
        homepage="Forms"
        activepage="Add OtherProduct"
      /> */}
        ...
        <Row>
          <Col xl={12}>
            <Card className="custom-card">
              <Card.Header>
                <div className="card-title">Add OtherProduct</div>
              </Card.Header>
              <Card.Body>
