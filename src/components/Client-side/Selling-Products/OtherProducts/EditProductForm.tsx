...
import useEditOtherProductForm from "../../../Hook/Selling-Products-Hook/OtherProductsTS/useEditOtherProductForm";
...
const EditOtherProductForm: FC = () => {
  ...
  return (
    <Fragment>
      {/* <Pageheader 
        heading="Edit OtherProduct"
        homepage="Forms"
        activepage="Edit OtherProduct"
      /> */}
        ...
        <Row>
          <Col xl={12}>
            <Card className="custom-card">
              <Card.Header>
                <div className="card-title">Edit OtherProduct</div>
              </Card.Header>
              <Card.Body>
                <Form onSubmit={handleSubmit}>
                  <Row className="gy-4">
                    {[
                      ...
                      {
                        name: "transferOtherProduct",
                        label: "Transfer OtherProduct",
                        type: "select",
                        options: [
                          { name: "Yes", id: 1 },
                          { name: "No", id: 0 },
