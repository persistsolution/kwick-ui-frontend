  ...
  return (
    <Fragment>
                    ...
                    {currentCategories.length > 0 ? (
                      currentCategories.map((category: any) => (
                        <tr key={category.id}>
                          ...
                          <td>
                            <button onClick={() => toggleEdit(category.id)} className="btn btn-md btn-icon btn-info-light rounded-circle" >
                              <i className="bi bi-pencil-square"></i>
                            </button>
                            &nbsp; &nbsp;
                            <button onClick={() => handleOpenCloseDltAlrt(category.id)} className="btn btn-md btn-icon btn-secondary-light rounded-circle" >
      ...
      <DeleteAlert
        ...
        handleOpenCloseDltAlrt={()=>handleOpenCloseDltAlrt(deleteId)}
