...
import useViewFrEmployee from "../../../../Hook/SubFranchise/Employee/ViewEmployee/useViewFrEmployee";

const ViewFrEmployee: FC = () => {
  const {
    indexOfLastEmployee,
                  ...
                  >
                    ...
                    <tbody>
                      {filteredEmployee.length > 0 ? (
                        filteredEmployee.map((employee: any) => (
                          <tr key={employee.id}>
                            <td>{employee.id}</td>
                            <td>
                              <img
