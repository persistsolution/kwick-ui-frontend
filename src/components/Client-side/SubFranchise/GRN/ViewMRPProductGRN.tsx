...
import useViewMRPProductGRN from "../../../Hook/SubFranchise/GRN/useViewMRPProductGRN";
import Select from "react-select";

const ViewMRPProductGRN: FC = () => {
    const {
                            ...
                            <Card.Body>
                                <div className="row align-items-center g-2 mb-3">
                                    ...
                                    <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                                        ...
                                        <Form.Select
                                            value={MRPProductGRNPerPage}
                                            onChange={(e) =>
                                                setMRPProductGRNPerPage(Number(e.target.value))
                                            }
                                            className="w-auto"
                                        >
                                            ...
                                            <option value={MRPProductGRN.length}>All Items</option>
                                        </Form.Select>
                                ...
                                <div className="table-responsive">
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            {MRPProductGRN.length > 0 ? (
                                                MRPProductGRN.map((franchise: any) => (
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                                    <div>
                                        Showing {indexOfFirstMRPProductGRN + 1} to{" "}
                                        {Math.min(indexOfLastMRPProductGRN, MRPProductGRN.length)} of{" "}
                                        {MRPProductGRN.length} entries
                                    </div>
...
export default ViewMRPProductGRN;
