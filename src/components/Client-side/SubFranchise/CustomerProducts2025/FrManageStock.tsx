...
import useFrManageStock from "../../../Hook/CustomerProducts2025/useFrManageStock";

const FrManageStock: FC = () => {
    const {
                            ...
                            <Card.Body>
                                <div className="row align-items-center g-2 mb-3">
                                    ...
                                    <div className="col-md-2 col-12 mt-4">
                                        <Button variant="success" className="me-2" onClick={handleFetchFrManageStock}>
                                            Search
                                        </Button>
                                    </div>
                                    ...
                                    <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                                        <Form.Select
                                            value={FrManageStockPerPage}
                                            onChange={(e) =>
                                                setFrManageStockPerPage(Number(e.target.value))
                                            }
                                            className="w-auto"
                                        >
                                            ...
                                            <option value={FrManageStock.length}>All Items</option>
                                        </Form.Select>
                                ...
                                <div className="table-responsive">
                                    {loading ? (
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                {currentFrManageStock.length > 0 ? (
                                                    currentFrManageStock.map((data: any) => (
                                                        <tr key={data.id}>
                                                            <td>{data.id}</td>
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                                    <div>
                                        Showing {indexOfFirstFrManageStock + 1} to{" "}
                                        {Math.min(indexOfLastFrManageStock, FrManageStock.length)} of{" "}
                                        {FrManageStock.length} entries
                                    </div>
