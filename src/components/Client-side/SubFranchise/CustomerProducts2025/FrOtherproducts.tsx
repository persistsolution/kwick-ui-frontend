...
import useFrOtherproducts from "../../../Hook/CustomerProducts2025/useFrOtherproducts";

const FrOtherproducts: FC = () => {
    const {
                            ...
                            <Card.Body>
                                <div className="row align-items-center g-2 mb-3">
                                    ...
                                    <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                                        <Form.Select
                                            value={FrOtherproductsPerPage}
                                            onChange={(e) =>
                                                setFrOtherproductsPerPage(Number(e.target.value))
                                            }
                                            className="w-auto"
                                        >
                                            ...
                                            <option value={FrOtherproducts.length}>All Items</option>
                                        </Form.Select>
                                ...
                                <div className="table-responsive">
                                    {loading ? (
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                {currentFrOtherproducts.length > 0 ? (
                                                    currentFrOtherproducts.map((data: any) => (
                                                        <tr key={data.id}>
                                                            <td> <img
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                                    <div>
                                        Showing {indexOfFirstFrOtherproducts + 1} to{" "}
                                        {Math.min(indexOfLastFrOtherproducts, FrOtherproducts.length)} of{" "}
                                        {FrOtherproducts.length} entries
                                    </div>
...
export default FrOtherproducts;
