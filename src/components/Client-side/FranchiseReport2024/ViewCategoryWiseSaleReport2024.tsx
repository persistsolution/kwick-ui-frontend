...
import useViewCategoryWiseSaleReport2024 from "../../Hook/FranchiseReport2024/useViewCategoryWiseSaleReport2024";

const ViewCategoryWiseSaleReport2024: FC = () => {
    const {
    ...
    } = useViewCategoryWiseSaleReport2024();
                            ...
                            <Card.Body>
                                <div className="row align-items-center g-2 mb-3">
                                    ...
                                    <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                                        <Form.Select
                                            value={CategoryWiseSaleReport2024PerPage}
                                            onChange={(e) =>
                                                setCategoryWiseSaleReport2024PerPage(Number(e.target.value))
                                            }
                                            className="w-auto"
                                        >
                                            ...
                                            <option value={CategoryWiseSaleReport2024.length}>All Items</option>
                                        </Form.Select>
                                ...
                                <div className="table-responsive">
                                    <Table
                                        id="CategoryWiseSaleReport2024-table"
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            {CategoryWiseSaleReport2024.length > 0 ? (
                                                CategoryWiseSaleReport2024.map((CategoryWiseSaleReport2024: any) => (
                                                    <tr key={CategoryWiseSaleReport2024.id}></tr>
                                                ))
                                            ) : (
                                                <tr>
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                                    <div>
                                        Showing {indexOfFirstCategoryWiseSaleReport2024 + 1} to{" "}
                                        {Math.min(
                                            indexOfLastCategoryWiseSaleReport2024,
                                            CategoryWiseSaleReport2024.length
                                        )}{" "}
                                        of {CategoryWiseSaleReport2024.length} entries
                                    </div>
...
export default ViewCategoryWiseSaleReport2024;
