...
import useViewDiscountInvoiceReport2024 from "../../Hook/FranchiseReport2024/useViewDiscountInvoiceReport";

const ViewDiscountInvoiceReport2024: FC = () => {
    const {
    ...
    } = useViewDiscountInvoiceReport2024();
                            ...
                            <Card.Body>
                                ...
                                <div className="row align-items-center g-2 mb-3">
                                    ...
                                    <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                                        <Form.Select
                                            value={DiscountInvoiceReport2024PerPage}
                                            onChange={(e) =>
                                                setDiscountInvoiceReport2024PerPage(Number(e.target.value))
                                            }
                                            className="w-auto"
                                        >
                                            ...
                                            <option value={DiscountInvoiceReport2024.length}>All Items</option>
                                        </Form.Select>
                                ...
                                <div className="table-responsive">
                                    <Table
                                        id="DiscountInvoiceReport2024-table"
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            {DiscountInvoiceReport2024.length > 0 ? (
                                                DiscountInvoiceReport2024.map((DiscountInvoiceReport2024: any) => (
                                                    <tr key={DiscountInvoiceReport2024.id}></tr>
                                                ))
                                            ) : (
                                                <tr>
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                                    <div>
                                        Showing {indexOfFirstDiscountInvoiceReport2024 + 1} to{" "}
                                        {Math.min(
                                            indexOfLastDiscountInvoiceReport2024,
                                            DiscountInvoiceReport2024.length
                                        )}{" "}
                                        of {DiscountInvoiceReport2024.length} entries
                                    </div>
...
export default ViewDiscountInvoiceReport2024;
