...
import useViewProductWiseSaleReport2024 from "../../Hook/FranchiseReport2024/useViewProductWiseSaleReport";

const ViewProductWiseSaleReport2024: FC = () => {
    const {
    ...
    } = useViewProductWiseSaleReport2024();
                            ...
                            <Card.Body>
                                ...
                                <div className="row align-items-center g-2 mb-3">
                                    ...
                                    <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                                        <Form.Select
                                            value={ProductWiseSaleReport2024PerPage}
                                            onChange={(e) =>
                                                setProductWiseSaleReport2024PerPage(Number(e.target.value))
                                            }
                                            className="w-auto"
                                        >
                                            ...
                                            <option value={ProductWiseSaleReport2024.length}>All Items</option>
                                        </Form.Select>
                                ...
                                <div className="table-responsive">
                                    <Table
                                        id="ProductWiseSaleReport2024-table"
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            {ProductWiseSaleReport2024.length > 0 ? (
                                                ProductWiseSaleReport2024.map((ProductWiseSaleReport2024: any) => (
                                                    <tr key={ProductWiseSaleReport2024.id}></tr>
                                                ))
                                            ) : (
                                                <tr>
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                                    <div>
                                        Showing {indexOfFirstProductWiseSaleReport2024 + 1} to{" "}
                                        {Math.min(
                                            indexOfLastProductWiseSaleReport2024,
                                            ProductWiseSaleReport2024.length
                                        )}{" "}
                                        of {ProductWiseSaleReport2024.length} entries
                                    </div>
...
export default ViewProductWiseSaleReport2024;
