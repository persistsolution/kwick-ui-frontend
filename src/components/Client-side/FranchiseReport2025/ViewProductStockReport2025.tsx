                            ...
                            <Card.Body>
                                <div className="row align-items-center g-2 mb-3">
                                    ...
                                    <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                                        <Form.Select
                                            value={ProductStockReport2025PerPage}
                                            onChange={(e) =>
                                                setProductStockReport2025PerPage(Number(e.target.value))
                                            }
                                            className="w-auto"
                                        >
                                            ...
                                            <option value={ProductStockReport2025.length}>All Items</option>
                                        </Form.Select>
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                                    <div>
                                        Showing {indexOfFirstProductStockReport2025 + 1} to{" "}
                                        {Math.min(
                                            indexOfLastProductStockReport2025,
                                            ProductStockReport2025.length
                                        )}{" "}
                                        of {ProductStockReport2025.length} entries
                                    </div>
...
export default ViewProductStockReport2025;
