...
import useViewProductWiseSaleReport2025 from "../../Hook/FranchiseReports2025/useViewProductWiseSaleReport2025";

const ViewProductWiseSaleReport2025: FC = () => {
    const {
    ...
    } = useViewProductWiseSaleReport2025();
                            ...
                            <Card.Body>
                                ...
                                <div className="row align-items-center g-2 mb-3">
                                    ...
                                    <div className="col-md-6 col-12 d-flex justify-content-md-end justify-content-between gap-2">
                                        <Form.Select
                                            value={ProductWiseSaleReport2025PerPage}
                                            onChange={(e) =>
                                                setProductWiseSaleReport2025PerPage(Number(e.target.value))
                                            }
                                            className="w-auto"
                                        >
                                            ...
                                            <option value={ProductWiseSaleReport2025.length}>All Items</option>
                                        </Form.Select>
                                ...
                                <div className="table-responsive">
                                    <Table
                                        id="ProductWiseSaleReport2025-table"
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            {ProductWiseSaleReport2025.length > 0 ? (
                                                ProductWiseSaleReport2025.map((ProductWiseSaleReport2025: any) => (
                                                    <tr key={ProductWiseSaleReport2025.id}></tr>
                                                ))
                                            ) : (
                                                <tr>
                                ...
                                <div className="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                                    <div>
                                        Showing {indexOfFirstProductWiseSaleReport2025 + 1} to{" "}
                                        {Math.min(
                                            indexOfLastProductWiseSaleReport2025,
                                            ProductWiseSaleReport2025.length
                                        )}{" "}
                                        of {ProductWiseSaleReport2025.length} entries
                                    </div>
...
export default ViewProductWiseSaleReport2025;
